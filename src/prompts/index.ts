        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "",
                "Context:",
                "- Arcane registers 177 tools by default, which bloats the tool-list context window.",
                ...
                "- full: all 177 (default on upgrade)",
                ...
                "",
                "Keep the conversation short — don't re-print the full 177-tool list. Confirm the chosen preset and summarise the tools/modules set before writing.",
              ].join("\n"),
            },
          },
        ],
