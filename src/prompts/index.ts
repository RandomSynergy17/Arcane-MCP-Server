        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "",
                "Context:",
                "- Arcane registers 174 tools by default, which bloats the tool-list context window.",
                ...
                "- full: all 174 (default on upgrade)",
                ...
                "",
                "Keep the conversation short — don't re-print the full 174-tool list. Confirm the chosen preset and summarise the tools/modules set before writing.",
              ].join("\n"),
            },
          },
        ],
