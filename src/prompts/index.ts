        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "",
                "Context:",
                "- Arcane registers 176 tools by default, which bloats the tool-list context window.",
                ...
                "- full: all 176 (default on upgrade)",
                ...
                "",
                "Keep the conversation short — don't re-print the full 176-tool list. Confirm the chosen preset and summarise the tools/modules set before writing.",
              ].join("\n"),
            },
          },
        ],
